...
const unsigned ASCII_OPEN_DLG_TYPES_COUNT = 29;
...
enum CC_ASCII_OPEN_DLG_TYPES {	ASCII_OPEN_DLG_None			= 0,
								...
								ASCII_OPEN_DLG_Scalar		= 17, //should always be the last one! (see AsciiOpenDlg::CheckOpenSequence)
								ASCII_OPEN_DLG_ID			= 18,
								ASCII_OPEN_DLG_EVENT		= 19,
								ASCII_OPEN_DLG_TIMES		= 20,
								ASCII_OPEN_DLG_EASTING		= 21,
								ASCII_OPEN_DLG_NORTHING		= 22,
								ASCII_OPEN_DLG_ELLIPSOIDHEIGHT = 23,
								ASCII_OPEN_DLG_omega		= 24,
								ASCII_OPEN_DLG_PHI			= 25,
								ASCII_OPEN_DLG_KAPPA		= 26,
								ASCII_OPEN_DLG_LAT			= 27,
								ASCII_OPEN_DLG_LONG			= 28
};
