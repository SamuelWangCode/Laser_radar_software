	...
	//auto-detect columns 'roles'
	{
		...
		if (columnsCount == 10)
		{
			for (unsigned i = 0; i < columnsCount; i++)
			{
				...
				if (i == 0)
				{
					columnHeaderWidget->setCurrentIndex(ASCII_OPEN_DLG_ID);
				}
				if (i == 1)
				{
					columnHeaderWidget->setCurrentIndex(ASCII_OPEN_DLG_EVENT);
				}
				if (i == 2)
				{
					columnHeaderWidget->setCurrentIndex(ASCII_OPEN_DLG_TIMES);
				}
				if (i == 3)
				{
					//columnHeaderWidget->setCurrentIndex(ASCII_OPEN_DLG_EASTING);
					columnHeaderWidget->setCurrentIndex(ASCII_OPEN_DLG_Y);
					assignedXYZFlags |= Y_BIT;
				}
				if (i == 4)
				{
					//columnHeaderWidget->setCurrentIndex(ASCII_OPEN_DLG_NORTHING);
					columnHeaderWidget->setCurrentIndex(ASCII_OPEN_DLG_X);
					assignedXYZFlags |= X_BIT;
				}
				if (i == 5)
				{
					//columnHeaderWidget->setCurrentIndex(ASCII_OPEN_DLG_ELLIPSOIDHEIGHT);
					columnHeaderWidget->setCurrentIndex(ASCII_OPEN_DLG_Z);
					assignedXYZFlags |= Z_BIT;
				}
				if (i == 6)
				{
					columnHeaderWidget->setCurrentIndex(ASCII_OPEN_DLG_omega);
				}
				if (i == 7)
				{
					columnHeaderWidget->setCurrentIndex(ASCII_OPEN_DLG_PHI);
				}
				if (i == 8)
				{
					columnHeaderWidget->setCurrentIndex(ASCII_OPEN_DLG_KAPPA);
				}
				if (i == 9)
				{
					columnHeaderWidget->setCurrentIndex(ASCII_OPEN_DLG_LAT);
				}
				if (i == 10)
				{
					columnHeaderWidget->setCurrentIndex(ASCII_OPEN_DLG_LONG);
				}
			}
		}
	}
